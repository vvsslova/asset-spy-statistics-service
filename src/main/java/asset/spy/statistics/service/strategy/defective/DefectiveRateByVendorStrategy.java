...
public class DefectiveRateByVendorStrategy implements StatisticsStrategy<Map<String, Double>> {
    ...
    public Map<String, Double> calculate() {
        try (Stream<ProductItemStatusEntity> stream = dataProvider.getAllStatusesAsStream()) {
            ...
            throw new RuntimeException("Error calculating defect rate by vendor", e);
        }
    }
}
