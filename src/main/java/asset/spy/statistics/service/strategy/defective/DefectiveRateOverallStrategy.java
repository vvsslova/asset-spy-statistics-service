...
public class DefectiveRateOverallStrategy implements StatisticsStrategy<Double> {
    ...
    public Double calculate() {
        try (Stream<ProductItemStatusEntity> stream = dataProvider.getAllStatusesAsStream()) {
            ...
            throw new RuntimeException("Error calculating defect rate for all products", e);
        }
    }
}
