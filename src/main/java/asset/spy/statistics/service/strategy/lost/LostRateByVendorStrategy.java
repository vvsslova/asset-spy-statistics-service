...
public class LostRateByVendorStrategy implements StatisticsStrategy<Map<String, Double>> {
    ...
    public Map<String, Double> calculate() {
        try (Stream<ProductItemStatusEntity> stream = dataProvider.getAllStatusesAsStream()) {
            ...
            throw new RuntimeException("Error calculating lost rate by vendor", e);
        }
    }
}
