...
public class AverageStatusDurationByVendorAndProductTypeStrategy implements StatisticsStrategy<Map<String, Map<String, Duration>>> {
    ...
    public Map<String, Map<String, Duration>> calculate() {
        try (Stream<ProductItemStatusEntity> stream = dataProvider.getAllStatusesAsStream()) {
            ...
            throw new RuntimeException("Error calculating average status duration by vendor and product type", e);
        }
    }
}
